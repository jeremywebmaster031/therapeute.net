    ...
    while (have_posts()) {
        ...
        <section class="lp-event-detail">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">                            <?php if (!empty($event_img)) {
                                ...
                                {"@context":"https://schema.org/","@type":"ImageObject","contentUrl":"<?php echo esc_url($event_img_thumb); ?>","license":"https://therapeute.net/license","acquireLicensePage":"https://therapeute.net/terms","creditText":"Redacteur therapeute .net","creator":{"@type":"Person","name":"<?php echo get_the_title($listing_id); ?>"},"copyrightNotice":"therapeute .net"}
                                </script>
                                <script type="application/ld+json">
            ...
            <?php 
                ...
                $addresss = "Paris France";
                $image_event_img = "https://i.ibb.co/XFJyZGK/Therapeute-net-logo.png";
                $description = mb_substr(wp_kses_post($event_object->post_content), 0, 125);
                if (!empty($event_time) && (!empty($event_date)) && (!empty($event_loc)) && (!empty($event_img)) && (!empty($event_object)) ) { 
                    $startDate =  date('Y-m-d\TH:i:s', $event_date);
                    $endDate = date('Y-m-d\TH:i:s', $event_date_end);
                    $image_event_img = esc_url($event_img);
                    $addresss = esc_attr($event_loc);
                }
                
            ?>

            <script type="application/ld+json">
            {"@context":"https://schema.org","@type":"Event","name":"<?php echo get_the_title($event_id); ?>","startDate":"<?php echo $startDate; ?>","endDate":"<?php echo $endDate; ?>","eventAttendanceMode":"https://schema.org/OfflineEventAttendanceMode","eventStatus":"https://schema.org/EventScheduled","location":{"@type":"Place","name":"Therapeute .net","address":{"@type":"PostalAddress","streetAddress":"<?php echo $addresss; ?>","addressLocality":"France","postalCode":"75000","addressRegion":"PA","addressCountry":"FR"}},"image":["<?php echo esc_url($image_event_img); ?>","https://i.ibb.co/5YqHDRb/therapeute.png"],"description":"<?php echo $description; ?>.","offers":{"@type":"Offer","url":"<?php echo get_the_permalink(); ?>","price":"30","priceCurrency":"USD","availability":"https://schema.org/InStock","validFrom":"<?php echo $endDate; ?>"},"performer":{"@type":"PerformingGroup","name":"<?php echo get_the_title($listing_id); ?> and Therapeute .net"},"organizer":{"@type":"Organization","name":"<?php echo get_the_title($listing_id); ?>","url":"<?php echo get_permalink($listing_id); ?>"}}
            </script>
