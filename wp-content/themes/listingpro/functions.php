...
function shortcode_slider_one(){
	$the_query = new WP_Query( array( 'post_type' => 'listing', 'post__in' => array( 2307,1851, 1842, 1839 ) ) );
	if ( $the_query->have_posts() ) {
		echo '<section class="section-loop"><div class="gallery js-flickity" data-flickity=\'{ "wrapAround": true }\'>';
		while ( $the_query->have_posts() ) {
			$the_query->the_post();
			$listingContent = get_post(get_the_ID());
...
add_shortcode('shortcode_slider', 'shortcode_slider_one');
