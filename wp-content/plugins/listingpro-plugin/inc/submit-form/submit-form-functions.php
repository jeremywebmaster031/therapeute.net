    ...
    if (!function_exists('lp_submit_form_sec_cd')) {
        ...
        if (!function_exists('inputDescription')) {
            function inputDescription($atts)
            {
                ...
                <div class="row">
                    <div class="form-group col-md-12 col-xs-12">
                        <label for="inputDescription" data-desimg="<?php echo $atts['tipimage']; ?>" data-quick-tip="<h2><?php echo $atts['tiptitle']; ?></h2><p><?php echo $atts['tipdesc']; ?></p>"><?php echo $atts['label'] ?></label>
                        <?php
                        if (isset($lp_post) && !empty($lp_post)) {
                            $settings = array(
                                'wpautop' => true,
