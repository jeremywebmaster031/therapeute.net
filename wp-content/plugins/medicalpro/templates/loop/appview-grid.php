...
if (!empty($showthisadinSidebar)) {
			...
			$listing_style = '';
				...
				if($adStatus == 'active'){
					...
					$CHeckAd = '<span class="listing-pro">'.esc_html__('Ad','medicalpro').'</span>';
					  ...
					  <div class="gaddress" style="display:none"><?php echo esc_attr($gAddress); ?></div>
						...
						<div class="lp-grid-box lp-border">
                            ...
                            <div class="lp-grid-box-thumb pos-relative">
                                            ...
                                            $image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID()), 'listingpro-thumb4' );
                                                ...
                                                if(!empty($image[0])){
                                                    ...
                                                    <a href="'.get_the_permalink().'" >
                                                        ...
                                                        <img src="'.esc_html__('https://via.placeholder.com/272x300', 'medicalpro').'" alt="image">
                                            ...
                                            $image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID()), 'listingpro-author-thumb' );
                                                ...
                                                if(!empty($image[0])){
                                                    ...
                                                    <a href="'.get_the_permalink().'" >
                                                        ...
                                                        <img src="'.esc_html__('https://via.placeholder.com/63x63', 'medicalpro').'" alt="image">
								...
								<a href="#" data-post-type="grids" data-post-id="<?php echo esc_attr(get_the_ID()); ?>" data-success-text="<?php echo esc_html__('Saved', 'medicalpro') ?>" class="status-btn add-to-fav lp-add-to-fav">
													...
													<?php
														...
														$NumberRating = listingpro_ratings_numbers($post->ID);
															...
															if($NumberRating <= 1){
																...
																$review = esc_html__('Rating', 'medicalpro');

															}else{

																$review = esc_html__('Ratings', 'medicalpro');
