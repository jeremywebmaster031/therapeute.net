...
<div class="lp-dashboard-booking-calander-header clearfix">
    <p class="grid-btn back-to-all-bookings"><i
                class="fa fa-chevron-left"></i><?php echo esc_html__('All Appointments', 'listingpro-bookings'); ?></p>
    <br>
    <div class="pull-left lp-dashboard-booking-calander-header-title"><?php echo esc_html__('Calendar', 'listingpro-bookings'); ?></div>
    <div class="pull-right lp-dashboard-booking-calander-header-status">
        <div class="booking-status approved pull-left"></div><?php echo esc_html__('Calendar only displays the approved Appointments.', 'listingpro-bookings'); ?>
    </div>
</div>
...
<div class="booking-grid-wrapper">
    <div class="custom-col-width col-md-9 booking-left-section">
        <div class="clearfix lp-dashboard-panel-outer lp-new-dashboard-panel-outer margin-top-20"
             style="display: none;">
        ...
        <div class="bookings">
            ...
            <div class="panel with-nav-tabs panel-default lp-dashboard-tabs col-md-12 lp-left-panel-height lp-left-panel-height-outer padding-bottom0">
                <div class="lp-menu-step-one margin-top-20">
                    <div class="panel-heading">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="#all-bookings" data-toggle="tab"
                                   aria-expanded="true"><?php echo esc_html__('All', 'listingpro-bookings'); ?></a>
                            </li>
                            <li class="">
                                <a href="#pending-bookings" data-toggle="tab"
                                   aria-expanded="false"><?php echo esc_html__('PENDING', 'listingpro-bookings'); ?></a>
                            </li>
                            <li class="">
                                <a href="#approved-bookings" data-toggle="tab"
                                   aria-expanded="false"><?php echo esc_html__('APPROVED', 'listingpro-bookings'); ?></a>
                            </li>
                            <li class="">
                                <a href="#canceled-bookings" data-toggle="tab"
                                   aria-expanded="false"><?php echo esc_html__('CANCELED', 'listingpro-bookings'); ?></a>
                            </li>
                            <li class="">
                                <a href="#expired-bookings" data-toggle="tab"
                                   aria-expanded="false"><?php echo esc_html__('Expired', 'listingpro-bookings'); ?></a>
                            </li>
                            <li class="pull-right">
                                <a href="" data-toggle="tab" aria-expanded="false">
                                    <button class="btn calendar-btn" data-bookings_type="manage-bookings"
                                            data-last-day="<?php echo date('t F Y'); ?>"
                                            data-first-day="<?php echo '1 ' . date('F Y'); ?>"><i class="fa fa-calendar"
                                                                                                  aria-hidden="true"></i>
                ...
                <ue
                = class="tab-content lp-tab-content-outer clearfix">
                    ...
                    <div class="booking-content">
                        ...
                        if (is_array($lp_bookings_arr) && !empty($lp_bookings_arr) && count($lp_bookings_arr) > 0) {
                            foreach ($lp_bookings_arr as $k => $v) {
                                ...
                                set_query_var('my_bookings', 'false');
                ...
                <input class="pending_listing_Arr" type="hidden"
                       value="<?php echo $pending_listing_Arr . ' ' . esc_html__('Appointments are pending approval. Pending appointments will only show in calendar upon approval.', 'listingpro-bookings'); ?>">
            </div>
        </div>
    </div>

    <div class="custom-col-width col-md-3 tab-content lp-tab-content-outer">
        <div class="bookings-sidebar tab-pane fade active in" id="mp-booking-details-sidebar">
            <div class="lp-dashboard-tabs">
                ...
                <div class="lp-menu-step-one">
                    <div class="panel-heading">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="#booking-details-sidebar" data-toggle="tab"
                                   aria-expanded="true"><?php echo esc_html__('Details', 'listingpro-bookings'); ?></a>
                            </li>
                            <li class="">
                                <a href="#booking-settings-sidebar" data-toggle="tab"
                                   aria-expanded="false"><?php echo esc_html__('Settings', 'listingpro-bookings'); ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div id="booking-settings-sidebar" class="tab-pane fade in pos-relative">
                <?php
                $lp_booking_timeslot_duration = get_user_meta(get_current_user_id(), 'lp_booking_timeslot_duration', true);
                ...
                <div class="user-booking-settings">
                    ...
                    <select class="form-control" id="mp-dashboard-timeslot">
                        <option value="15" <?php if ($lp_booking_timeslot_duration == '15') {
                            echo 'selected';
                        }; ?>><?php echo esc_html__('15 Minutes', 'listingpro-bookings'); ?> </option>
                        <option value="30" <?php if ($lp_booking_timeslot_duration == '30') {
                            echo 'selected';
                        }; ?>><?php echo esc_html__('30 Minutes', 'listingpro-bookings'); ?> </option>
                        <option value="45" <?php if ($lp_booking_timeslot_duration == '45') {
                            echo 'selected';
                        }; ?>><?php echo esc_html__('45 Minutes', 'listingpro-bookings'); ?> </option>
                        <option value="60" <?php if ($lp_booking_timeslot_duration == '60') {
                            echo 'selected';
                        }; ?>><?php echo esc_html__('60 Minutes', 'listingpro-bookings'); ?> </option>
                        <option value="90" <?php if ($lp_booking_timeslot_duration == '90') {
                            echo 'selected';
                        }; ?>><?php echo esc_html__('90 Minutes', 'listingpro-bookings'); ?> </option>
                    </select>
                </div>
            </div>
        </div>
