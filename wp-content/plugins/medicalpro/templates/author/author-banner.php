        ...
        <div class="container">
            <div class="row">
                ...
                <div class="lp-banner-date">
                    <p><?php echo esc_html__( 'Joined In', 'medicalpro' ); ?> <?php echo date_i18n( 'M Y', $joined ); ?></p>
                </div>
                    ...
                    <div class="lp-banner-bottom-left">
                        ...
                        <ul>
                            ...
                            <li class="banner-ratings">
                                ...
                                <strong><?php echo esc_attr($review_count); ?></strong> <span><?php echo esc_html__( 'Reviews Submitted', 'medicalpro' ); ?></span>
                            </li>
                            <?php endif; ?>
                            <?php
                            if( $counter_photos == 1 ):
                            ...
                            <li class="banner-photos">
                                ...
                                <strong><?php echo esc_attr($photos_count); ?></strong> <span><?php echo esc_html__( 'Photos', 'medicalpro' ); ?></span>
                            </li>
                            <?php endif;; ?>
                            <?php
                            ...
                            <li class="banner-list">
                                ...
                                <strong><?php echo esc_attr($listings_count); ?></strong> <span><?php echo esc_html__( 'Listing', 'medicalpro' ); ?></span>
                            </li>
                            <?php endif; ?>
                        </ul>
                        <?php endif; ?>
