...
<div class="author-about-wrap">
    <div class="row">
        <div class="col-md-7">
            ...
            <?php else: ?>
                <p><?php echo esc_html__( 'No info available', 'medicalpro' ); ?></p>
            <?php endif; ?>
        </div>
        <div class="col-md-5">
            <?php
            ...
            <div class="info-row">
                <p>
                    <label><?php echo esc_html__( 'website', 'medicalpro' ); ?></label>
            ...
            <div class="info-row">
                <p>
                    <label><?php echo esc_html__( 'Phone', 'medicalpro' ); ?></label>
            ...
            <div class="info-row">
                <p>
                    <label><?php echo esc_html__( 'Address', 'medicalpro' ); ?></label>
            ...
            if ($social_show == 1):
                if ($author_fb != '' || $author_tw != '' || $author_pin != '' || $author_insta || $author_link != ''):
                    ?>
                    <div class="info-row">
                        <h5 class="author-contact-second-heading"><?php echo esc_html__('Social', 'medicalpro'); ?></h5>
            ...
            <div class="about-activities-inner">
                ...
                if( $my_query->have_posts() ):
                    ...
                    while ( $my_query->have_posts() ): $my_query->the_post();
                        ...
                        if(class_exists('MedicalPro')){
                            mp_activity_reviews( $review_id, $authorID );
                        }else {
                    ...
                    echo esc_html__( 'No Review Found', 'medicalpro' );
                endif;
                ?>
            </div>
