...
$title = '';
if (!empty(get_the_title())) : $title = '<span class="pull-left">' . get_the_title() . '</span>'; endif;
$outputHorz .= '
...
$recurring_output = apply_filters('lp_price_plan_recurring_duration', '', get_the_ID(), 'horizontal_view_1');
...
$insurances_show = get_post_meta(get_the_ID(), 'insurances_show', true);
if ($insurances_show == "true") {
    $insurances_show = 'checked';
} else {
    $insurances_show = 'unchecked';
}
$awards_show = get_post_meta(get_the_ID(), 'awards_show', true);
if ($awards_show == "true") {
    $awards_show = 'checked';
} else {
    $awards_show = 'unchecked';
}
$video_consult_show = get_post_meta(get_the_ID(), 'video_consult_show', true);
if ($video_consult_show == "true") {
    $video_consult_show = 'checked';
} else {
    $video_consult_show = 'unchecked';
}

if (get_post_meta(get_the_ID(), 'insurances_show_hide', true) == '') {
    $outputHorz .= '<li>
        <span class="icon-text">' . listingpro_fontawesome_icon($insurances_show) . '</span>
        <span>' . esc_html__('Insurances', 'listingpro-plugin') . '</span>
    </li>';
}
if (get_post_meta(get_the_ID(), 'awards_show_hide', true) == '') {
    $outputHorz .= '<li>
        <span class="icon-text">' . listingpro_fontawesome_icon($awards_show) . '</span>
        <span>' . esc_html__('Awards', 'listingpro-plugin') . '</span>
    </li>';
}
if (get_post_meta(get_the_ID(), 'video_consult_show_hide', true) == '') {
    $outputHorz .= '<li>
        <span class="icon-text">' . listingpro_fontawesome_icon($video_consult_show) . '</span>
        <span>' . esc_html__('Video Consultation', 'listingpro-plugin') . '</span>
    </li>';
}
