...
class MedicalPro_Submit_Listing extends Widget_Base
{

    public function get_name()
    {
        return 'mp-submit-listing';
    }

    public function get_title()
    {
        return __('Submit Listing', 'elementor-medicalpro');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'title',
            [
                'label' => __('Title', 'elementor-medicalpro'),
        ...
        $this->add_control(
            'subtitle',
            [
                'label' => __('Subtitle', 'elementor-medicalpro'),
                'type' => Controls_Manager::TEXT,
            ]
        );
    ...
    protected function render()
    {
        ...
        echo elementor_medpro_shortcode_submit($settings);
    }
...
if (!function_exists('elementor_medpro_shortcode_submit')) {
    function elementor_medpro_shortcode_submit($atts, $content = null)
    {
            ...
            if ($page_style == 'style2') {
                ...
                if (!empty($cat_plan_id)) {
                    ...
                    if ($singleCatMode == true) {
                        ...
                        $output .= '<select data-catimg="' . $quicktip_cat . '" data-quick-tip="<h2>' . esc_html__('Categories', 'medicalpro') . '</h2><p>' . esc_html__('The more specific you get with your categories, the better. You do still want to stay relevant to your business, though. If you ever choose to run ads campaign, your ad will be shown on those categories you select.', 'medicalpro') . '</p>" data-placeholder="' . esc_html__('Choose Your Business Category', 'medicalpro') . '" id="inputCategory" name="category[]" class="select2 postsubmitSelect" tabindex="5" multiple="multiple">';
                    }
