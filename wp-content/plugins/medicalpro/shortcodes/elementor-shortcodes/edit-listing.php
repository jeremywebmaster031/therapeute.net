...
class MedicalPro_Edit_Listing extends Widget_Base
{

    public function get_name()
    {
        return 'mp-edit-listing';
    }

    public function get_title()
    {
        return __('Edit Listing', 'elementor-medicalpro');
    }
    ...
    protected function render()
    {
        ...
        echo elementor_medpro_shortcode_edit($settings);
    }
...
if (!function_exists('elementor_medpro_shortcode_edit')) {
    function elementor_medpro_shortcode_edit($atts, $content = null)
    {
